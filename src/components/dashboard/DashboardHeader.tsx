...
export function DashboardHeader({ period, periods, onPeriodChange, onReport }: { period: Period; periods: Record<Period, string>; onPeriodChange: (period: Period) => void; onReport: () => void }) {
