...
export function EmployeeSection({ period }: { period: Period }) { const { data, isFallback } = useDashboardData("sdm", period); return <section><SectionLabel isFallback={isFallback}>Sumber Daya Manusia</SectionLabel><h2>Kapasitas tenaga kerja</h2><p className="note">Ringkasan tenaga kerja lintas direktorat dan unit pendukung.</p><div className="layout"><EmployeeTable employees={data.employees} /><EmployeeChart /></div></section>; }
